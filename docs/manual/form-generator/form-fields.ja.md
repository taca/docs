...
![Edit form fields](/ja/form-generator/images/en/formfield-editor.png?classes=shadow)
...
![A select menu in the frontend](/ja/form-generator/images/en/select-menu-in-frontend.png?classes=shadow)
...
![JavaScript wizard for creating options](/ja/form-generator/images/en/select-options-wizard.png?classes=shadow)
...
![A radio button menu in the front end](/ja/form-generator/images/en/radio-button-in-frontend.png?classes=shadow)
...
![A checkbox menu in the frontend](/ja/form-generator/images/en/checkboxes-in-frontend.png?classes=shadow)
