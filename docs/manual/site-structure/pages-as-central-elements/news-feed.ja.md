...
aliases:
    - /ja/site-structure/pages-as-central-elements/news-feed/
    - /ja/layout/site-structure/pages-as-central-elements/news-feed/
weight: 100
---
...
The feeds can be integrated via the [page layout](/ja/layout/theme-manager/manage-page-layouts/#rss-atom-feeds) in 
