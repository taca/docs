...
aliases:
    - /ja/site-structure/pages-as-central-elements/service-unavailable/
    - /ja/layout/site-structure/pages-as-central-elements/service-unavailable/
weight: 90
---


This page is called when a root page is in maintenance mode. Maintenance mode can be enabled in the 
[Website root](/ja/site-structure/pages-as-central-elements/website-root/).
