...
![Calendar modules]({{% asset "images/manual/core-extensions/calendar/ja/kalender-module.png" %}}?classes=shadow)
...
![The default calendar module in the frontend]({{% asset "images/manual/core-extensions/calendar/ja/the-default-calendar-module-in-the-frontend.png" %}}?classes=shadow)

**Mini calendar module `cal_mini`**

![The mini calendar module in the frontend]({{% asset "images/manual/core-extensions/calendar/ja/the-mini-calendar-module-in-the-frontend.png" %}}?classes=shadow)
...
For details on how to mark up the comments, see the [comments](/ja/article-management/content-elements/include-elements/#comments) section.
