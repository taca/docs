...
To create a new channel click on ![Create a new channel](/ja/icons/new.svg?classes=icon "Create a new 
channel") **New**.
...
To create a new newsletter click on ![Edit channel](/ja/icons/edit.svg?classes=icon "Edit Channel") and 
then on New ![Create a new newsletter](/ja/icons/new.svg?classes=icon "Create a new newsletter").
...
![Edit a recipient](/ja/core-extensions/newsletter/images/en/activate_recipients.png?classes=shadow)
...
on ![Edit subscribers of the distribution list](/ja/icons/mgroup.svg?classes=icon "Edit channel subscribers") and then 
on New ![Create a new subscriber](/ja/icons/new.svg?classes=icon "Create a new subscriber") or ![Edit subscriber](/de/icons/edit.svg?classes=icon 
"Edit Subscriber").
...
![Import newsletter recipients](/ja/core-extensions/newsletter/images/en/csv_import.png?classes=shadow)

Then start the import by clicking the button `CSV-Import`.

## Send newsletter

You can start sending a newsletter by clicking on the corresponding navigation ![Send newsletter](/ja/icons/send.svg?classes=icon "Send newsletter") symbol in the distribution list overview, which will take you to a preview page where 
...
![Sending a newsletter](/ja/core-extensions/newsletter/images/en/send_newsletter.png?classes=shadow)
...
![Resume interrupted sending](/ja/core-extensions/newsletter/images/en/system_log.png?classes=shadow)
