...
![Set the outer distance in the stylesheet editor](/ja/layout/theme-manager/images/en/set-the-outer-distance-in-the-stylesheet-editor.png?classes=shadow)
...
![Move format definition](/ja/icons/drag.svg?classes=icon) **Drag&amp;Drop** or
![Move format definition](/ja/icons/cut.svg?classes=icon) **Move and** 
![Insert after format definition](/ja/icons/pasteafter.svg?classes=icon) **then Insert**.
...
![Export style sheet](/ja/icons/theme_export.svg?classes=icon) **Export Stylesheet** behind the stylesheet.
