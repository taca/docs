...
aliases:
    - /ja/layout/theme-manager/manage-themes/
weight: 10
---
...
![Navigation icons in the Theme Manager](/ja/layout/theme-manager/images/en/navigation-icons-in-the-theme-manager.png?classes=shadow)

- ![Edit Theme](/ja/icons/edit.svg?classes=icon) Edit Theme
- ![Delete Theme](/ja/icons/delete.svg?classes=icon) Delete a theme
- ![Show details of the theme](/ja/icons/show.svg?classes=icon) Show details of the theme
- ![Edit the stylesheets of the theme](/ja/icons/css.svg?classes=icon) Edit the stylesheets of the theme
- ![Editing the front end modules of the Theme](/ja/icons/modules.svg?classes=icon) The front end modules of the theme editing
- ![Edit the page layouts of the theme](/ja/icons/layout.svg?classes=icon) The page layouts of the theme editing
- ![Edit the image sizes of the theme](/ja/icons/sizes.svg?classes=icon) Edit the image sizes of the theme
- ![Export Theme](/ja/icons/theme_export.svg?classes=icon) Export Theme
...
![The theme data is checked](/ja/layout/theme-manager/images/en/the-theme-data-is-checked.png?classes=shadow)
...
![Contao Official Demo](/ja/layout/theme-manager/images/en/contao-official-demo.png?classes=shadow)
