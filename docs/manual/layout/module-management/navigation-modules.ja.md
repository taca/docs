...
![The navigation menus in the front end](/ja/layout/module-management/images/en/the-navigation-menus-in-the-front-end.png?classes=shadow)
...
![The breadcrumb navigation in the front end](/ja/layout/module-management/images/en/the-breadcrumb-navigation-in-the-front-end.png?classes=shadow)
...
![The book navigation in the frontend](/ja/layout/module-management/images/en/the-book-navigation-in-the-frontend.png?classes=shadow)
...
![The article navigation in the front end](/ja/layout/module-management/images/en/the-article-navigation-in-the-front-end.png?classes=shadow)
