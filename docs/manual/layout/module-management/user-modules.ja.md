...
aliases:
    - /ja/layout/module-management/user-modules/
weight: 20
---
...
![Set editable fields](/ja/layout/module-management/images/en/set-editable-fields.png?classes=shadow)
...
described in [Further settings for starting points](/ja/layout/site-structure/configure-pages/#further-settings-for-starting-points) 
