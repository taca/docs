...
icons with the ![Open area](/ja/icons/folPlus.svg?classes=icon) plus or ![Close area](/de/icons/folMinus.svg?classes=icon) minus
sign to the left of the page names to expand or collapse sub pages.

![Toggle subpages](/ja/layout/site-structure/images/en/toggle-subpages.png?classes=shadow)
