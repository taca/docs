...
![Extension manager](/ja/extensions/images/en/extension-manager-composer-en.png?classes=shadow)
...
![Composer installation](/ja/extensions/images/en/composer-client-composer-installation-en.png?classes=shadow)
...
![Migration](/ja/extensions/images/en/composer-client-skip-migration-en.png?classes=shadow)
...
![Einstellungen](/ja/extensions/images/en/composer-client-min-stability-en.png?classes=shadow)
...
![Composer settings](/ja/extensions/images/en/composer-settings-en.png?classes=shadow)
...
![Composer Update 1](/ja/extensions/images/en/en-composer-client-update-1.png?classes=shadow)

![Composer Update 2](/ja/extensions/images/en/en-composer-client-update-2.png?classes=shadow)

![Composer Update 3](/ja/extensions/images/en/en-composer-client-update-3.png?classes=shadow)
...
![News Sync settings](/ja/extensions/images/en/contao-news-sync-1-en.png?classes=shadow)
...
![News Sync settings](/ja/extensions/images/en/contao-news-sync-2-en.png?classes=shadow)
