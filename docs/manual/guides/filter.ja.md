...
display, you could use the Contao [Accordeon elements](/ja/article-management/content-elements/#accordion) 
...
Alternatively, you could also store them as [JavaScript Asset](/ja/layout/templates/php/template-assets/) in the template.
{{% /notice %}}
...
»System maintenance« section of the [Contao Manager](/ja/installation/contao-manager/). Then call the 
[Contao installation tool](/ja/installation/contao-installtool/). The tool recognizes the new field and offers you to create it in the database table 
...
and a «.html5« [template file](/ja/layout/templates/) for output. You have to consider the following convention for the file names:
...
{{% notice note %}}
The extension »[MetaModels](/ja/extensions/metamodels/)« follows a similar approach and does not confront you with a direct Contao 
