...
aliases:
    - /ja/guides/tinymce-configuration/
weight: 40
tags:
    - "Template"
---
...
Create a new [template](/ja/layout/templates/) from  "Layout > Templates" in the 
[navigation area](/ja/administration-area/call-and-structure-of-the-backend/#the-navigation-area) and
...
{{% notice tip %}}
Starting with Contao **4.10** you can use [template inheritance](/ja/layout/templates/php/template-inheritance/) in order to
...
[allowed HTML tags](/ja/system/settings/#security-settings). It might happen that this information 
...
[Allowed HTML tags](/ja/system/settings/#security-settings), you have to enable this for the TinyMCE. 
