...
![Mumble Audio setup wizard](/ja/guides/images/en/mumble/mumble-audio-assistant.jpg?classes=shadow)

If you press the "Next" button, you can select your preferred audio input and output devices on the next screen.

![Mumble Audio Setup Wizard Device Selection](/ja/guides/images/en/mumble/mumble-audio-assistant-device-selection.jpg?classes=shadow)
...
![Mumble Audio Setup Wizard Device Setup](/ja/guides/images/en/mumble/mumble-audio-assistant-device-settings.jpg?classes=shadow)
...
![Mumble Audio Settings Wizard Volume](/ja/guides/images/en/mumble/mumble-audio-assistant-volume-settings.jpg?classes=shadow)
...
![Mumble Audio Settings Wizard Voice Activation](/ja/guides/images/en/mumble/mumble-audio-assistant-voice-activity.jpg?classes=shadow)
...
![Mumble Audio Settings Wizard Voice Quality](/ja/guides/images/en/mumble/mumble-audio-assistant-quality-info.jpg?classes=shadow)
...
![Mumble Audio Setting Wizard Audio Position](/ja/guides/images/en/mumble/mumble-audio-assistant-position-dependent-audio.jpg?classes=shadow)
...
![Mumble Certificate Management](/ja/guides/images/en/mumble/mumble-certificate-management.jpg?classes=shadow)
...
![Mumble Server Connection](/ja/guides/images/en/mumble/mumble-server-connect.jpg?classes=shadow)
...
![Select Mumble Server Connection](/ja/guides/images/en/mumble/mumble-server-select.jpg?classes=shadow)
...
![Mumble Status Window](/ja/guides/images/en/mumble/mumble-status.jpg?classes=shadow)
