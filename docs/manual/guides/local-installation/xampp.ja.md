...
weight: 30
aliases:
    - /ja/guides/local-installation/xampp/    
tags: 
   - "Installation"
---
...
According to the [Contao system requirements](/ja/installation/system-requirements/) we have to adjust the 
...
the [Contao manager](/ja/installation/contao-manager/). In addition, you can optionally change the entries 
