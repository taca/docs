...
![Search for "Create symbolic links"](/ja/guides/local-installation/images/en/laragon/01_polsedit.png?width=800px&classes=shadow)

- Double-click on "*Create symbolic links*" to open the policy's properties window:

![Open the policy entry](/ja/guides/local-installation/images/en/laragon/02_polsedit_policy_properties.png?width=300px&classes=shadow)
...
![Laragon Management Panel](/ja/guides/local-installation/images/en/laragon/03_laragon.png?width=500px&classes=shadow)
...
![Open menu in the Laragon Management Panel](/ja/guides/local-installation/images/en/laragon/04_laragon_menu.png?width=500px&classes=shadow)
...
![Laragon Settings](/ja/guides/local-installation/images/en/laragon/05_laragon_settings.png?width=500px&classes=shadow)
...
![Laragon Settings](/ja/guides/local-installation/images/en/laragon/06_laragon_services.png?width=500px&classes=shadow)
...
![Edit Laragon configuration file](/ja/guides/local-installation/images/en/laragon/07_laragon_ini.png?width=500px&classes=shadow)
...
![Open PHP quick settings](/ja/guides/local-installation/images/en/laragon/08_laragon_php.png?width=500px&classes=shadow)

- Select the entry "*memory_limit = …*" from the submenu and set the PHP memory limit to the value `-1` (or `2G`, `4G`):

![Set PHP memory limit](/ja/guides/local-installation/images/en/laragon/09_laragon_php_memory_limit.png?width=250px&classes=shadow)
...
![set sys_temp_dir](/ja/guides/local-installation/images/en/laragon/10_laragon_php_sys_temp_dir.png?width=250px&classes=shadow)
...
![Start web and database server](/ja/guides/local-installation/images/en/laragon/11_laragon_servers.png?width=500px&classes=shadow)
...
![Services successfully started](/ja/guides/local-installation/images/en/laragon/12_laragon_running.png?width=500px&classes=shadow)
...
![Laragon index page](/ja/guides/local-installation/images/en/laragon/13_laragon_localhost.png?width=500px&classes=shadow)
...
![Add Windows environment variable in the Laragon management panel](/ja/guides/local-installation/images/en/laragon/14_laragon_path.png?width=500px&classes=shadow)
...
![Customizing App Configurations](/ja/guides/local-installation/images/en/laragon/15_laragon_app_config.png?width=500px&classes=shadow)
...
![Install Composer](/ja/guides/local-installation/images/en/laragon/16_composer_install.png?width=500px&classes=shadow)
...
![Testing whether Composer was successfully installed](/ja/guides/local-installation/images/en/laragon/17_laragon_console.png?width=800px&classes=shadow)
...
![Create new website](/ja/guides/local-installation/images/en/laragon/18_laragon_website_project.png?width=500px&classes=shadow)
...
![Enter project name](/ja/guides/local-installation/images/en/laragon/19_laragon_websiteproject_2.png?width=250px&classes=shadow)
...
![Edit drivers\etc\hosts in the Laragon management panel](/ja/guides/local-installation/images/en/laragon/20_laragon_hosts.png?width=500px&classes=shadow)
...
![Contao installation tool](/ja/guides/local-installation/images/en/laragon/21_contao_installtool.png?width=800px&classes=shadow)
...
![Remove Website Project in the Laragon Management Panel](/ja/guides/local-installation/images/en/laragon/22_laragon_deleteproject.png?width=500px&classes=shadow)
...
![Open Laragon www folder in Explorer](/ja/guides/local-installation/images/en/laragon/23_laragon_www.png?width=500px&classes=shadow)
...
![Change PHP version](/ja/guides/local-installation/images/en/laragon/24_laragon_php_versions.png?width=500px&classes=shadow)

- Change Apache version:

![Changing Apache Version](/ja/guides/local-installation/images/en/laragon/25_laragon_apache_version.png?width=500px&classes=shadow)
