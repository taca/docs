...
[Page Layouts](/ja/layout/theme-manager/manage-page-layouts/) of your 
[Theme](/ja/layout/theme-manager/). Google provides the information required by the respective browser 
...
{{% notice info %}}
In the [Page layouts](/ja/layout/theme-manager/manage-page-layouts/) you may find direct 
...
via [Preprocessors](/ja/guides/sass-less-integration/) such as »Sass/Less«. 
...
[page layout](/ja/layout/theme-manager/manage-page-layouts/) section of your [theme](/en/layout/theme-manager/).
...
{{% notice note %}}
In [Page Layout](/ja/layout/theme-manager/manage-page-layouts/), you can activate the »Combine Scripts« option. All 
