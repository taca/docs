...
![Edit this page](/ja/contributing/images/de/diese-seite-bearbeiten.png?classes=shadow)
...
![Fork this repository](/ja/contributing/images/de/fork-this-repository.png?classes=shadow)
...
![Edit the content](/ja/contributing/images/de/inhalt-bearbeiten.png?classes=shadow)
...
![Create Branch and Commit](/ja/contributing/images/de/branch-und-commit-erzeugen.png?classes=shadow)
...
![Create pull request](/ja/contributing/images/de/create-pull-request.png?classes=shadow)
...
![GitHub Fetch upstream](/ja/contributing/images/de/github-fork-fetch-upstream.png?classes=shadow)
...
![GitHub message](/ja/contributing/images/de/github-message.png?classes=shadow)

Compare the changes and finish this step by clicking on "Create pull request".

![Compare changes](/ja/contributing/images/de/comparing-changes.png?classes=shadow)

Confirm the creation of a pull request with "Create pull request".

![Create pull request](/ja/contributing/images/de/open-a-pull-request.png?classes=shadow)
