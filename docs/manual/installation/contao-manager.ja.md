...
![Welcome page of the Contao Manager](/ja/installation/images/en/welcomepage-contao-manager.png?classes=shadow)
...
![Server configuration](/ja/installation/images/en/server-configuration.png?classes=shadow)
...
In this case, you can change the [config.yml](/ja/system/settings/#config-yml) accordingly. Afterwards, you have to 
