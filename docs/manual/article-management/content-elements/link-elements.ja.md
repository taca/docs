...
![Creating a hyperlink](/ja/article-management/images/en/create-a-hyperlink.png?classes=shadow)
...
![Create an image link](/ja/article-management/images/en/create-an-image-link.png?classes=shadow)
