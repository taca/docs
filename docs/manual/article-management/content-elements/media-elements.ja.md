...
![Create a screen element](/ja/article-management/images/en/create-an-imageelement.png?classes=shadow)
...
![The gallery in the frontend](/ja/article-management/images/en/the-gallery-in-the-frontend.png?classes=shadow)
