...
The content element "Form" adds a form to the article. For information on creating and managing forms, see the [Form Generator](/ja/form-generator/) section.
...
The content element "Module" adds a frontend module to the article. You already know how to create and configure modules from the section [Module Management](/ja/layout/module-management/).
...
![Filter comments by origin](/ja/article-management/images/en/filter-comments-by-origin.png?classes=shadow)
